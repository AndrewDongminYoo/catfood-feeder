-- Match normalizeSourceText's exact order: NFKC, collapse whitespace, trim,
-- lowercase. Trimming before NFKC leaves compatibility whitespace that NFKC
-- converts to an ordinary leading or trailing space.
