...
try {
  ...
  const prompt = [
    ...
    "",
    "Region order: Korean (ko-KR) first, then Asia-Pacific, then the brand's own",
    "home-country site, then global or North American English.",
    "A European-language page is right when the brand is from that country — for a",
    "German brand the German site IS the maker's page. It is wrong when the brand is",
    "from elsewhere and you landed on a European subsidiary, because those state a",
    "different regional formulation than the one imported to Korea.",
    "",
    "Rules:",
    ...
    "- carb_pct is ONLY a carbohydrate the label states itself, which Korean",
